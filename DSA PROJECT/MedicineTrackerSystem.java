...
public class MedicineTrackerSystem {
    ...
    static void performBinarySearch() {
        ...
        System.out.println("Note: List will be sorted first for binary search...");
...
class MedicineManager {
    ...
    public void compareAllSorts() {
        ...
        System.out.println("═══════════════════════════════════════════════════════");
        System.out.printf("%-20s | %15d\n", "Bubble Sort O(n^2)", bubbleTime);
        System.out.printf("%-20s | %15d\n", "Selection Sort O(n^2)", selectionTime);
    ...
    public void detectDuplicateTimes() {
        ...
        for (Map.Entry<String, List<String>> entry : timeMap.entrySet()) {
            if (entry.getValue().size() > 1) {
                ...
                System.out.println("WARNING - Time " + entry.getKey() + ": " + entry.getValue());
            }
        }
    ...
    public void demonstrateUndoRedo() {
        System.out.println("\nSTACK-BASED UNDO/REDO DEMONSTRATION");
        System.out.println("═════════════════════════════════════════");
    ...
    public void hashMapCollisionDemo() {
        System.out.println("\nHASHMAP COLLISION DEMONSTRATION");
        System.out.println("═════════════════════════════════════════");
            ...
            if (interactionWarnings.containsKey(med)) {
                for (String interacts : interactionWarnings.get(med)) {
                    if (activeMedicines.contains(interacts)) {
                        System.out.println("WARNING: " + med.toUpperCase() + 
    ...
    public void displayDailySummary() {
        ...
        System.out.println("║ Missed:          " + String.format("%-12d", missed) + "║");
        System.out.println("╚═══════════════════════════════╝");
    }
    ...
    public void displayLowStockAlert() {
        ...
        while (current != null) {
            if (current.data.isLowStock()) {
                System.out.println("LOW STOCK: " + current.data.getName() + 
    ...
    public void displayRefillReminders() {
        ...
        while (current != null) {
            if (current.data.needsRefill()) {
                System.out.println("REFILL: " + current.data.getName() + 
    ...
    public void analyzeComplexity() {
        ...
        System.out.printf("%-25s | %-12s | %-12s | %s\n", 
            "Bubble Sort", "O(n^2)", "O(1)", "ArrayList");
        System.out.printf("%-25s | %-12s | %-12s | %s\n", 
